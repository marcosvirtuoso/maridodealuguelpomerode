...
export default function Hero() {
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 py-24 pt-32 flex flex-col items-center text-center lg:items-start lg:text-left">
        {/* Badge */}
        ...
        {/* Heading — SEO H1 */}
        <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight text-primary-foreground max-w-3xl mb-6" style={{ fontFamily: "'Playfair Display', serif" }}>
          Reparos Residenciais{" "}
          <span className="text-gradient-gold">Profissionais</span>{" "}
          em Pomerode
        </h1>

        <p className="text-base sm:text-lg lg:text-xl text-primary-foreground/80 max-w-xl mb-4 leading-relaxed">
        ...
        {/* Trust indicators */}
        <div className="mt-12 flex flex-wrap justify-center lg:justify-start gap-6 text-primary-foreground/70 text-sm">
          {[
      ...
      {/* Scroll indicator */}
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-primary-foreground/40 animate-bounce" aria-hidden="true">
