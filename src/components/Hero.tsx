...
export default function Hero() {
  ...
  return (
    <section
      ...
      {/* Overlay + content */}
      <div className="absolute inset-0 z-[1] flex items-center justify-center hero-overlay">
        <style>{`
          .hero-overlay {
            background: linear-gradient(to right, hsl(220 60% 20% / 0.75) 0%, hsl(220 60% 20% / 0.75) 50%, hsl(220 60% 20% / 0.2) 100%);
          }
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-4 sm:px-6 flex flex-col lg:flex-row items-stretch justify-between gap-8">
        ...
        <div className="flex flex-col items-center text-center lg:items-start lg:text-left lg:max-w-[55%]" style={{ padding: "40px 0", marginLeft: "0" }} 
          ...
          <h1
            ...
            <span className="text-gradient-gold">Pomerode</span>{" "}
            e Região.
          </h1>

          <p className="text-xs sm:text-sm lg:text-base text-primary-foreground/80 max-w-lg mb-4 leading-relaxed">
