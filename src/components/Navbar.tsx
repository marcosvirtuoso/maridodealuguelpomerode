      ...
      >
        ...
        >
          ...
          <div className="leading-tight">
            <span className="block text-sm font-bold text-primary-foreground tracking-wide">Marido de Aluguel</span>
            <span className="block text-[10px] text-gold font-medium tracking-widest uppercase">Pomerode · SC</span>
          </div>
        </a>
        ...
        <div className="hidden md:flex items-center gap-2">
          <a
            href="https://www.instagram.com/maridodealuguelpomerode/"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center justify-center w-10 h-10 rounded-xl bg-gradient-to-br from-[#f09433] via-[#e6683c] to-[#dc2743] hover:opacity-90 transition-opacity"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex btn-whatsapp items-center gap-2 px-5 py-2.5 text-sm font-bold"
